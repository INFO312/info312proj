...
import domain.ApplicationSessionObject;
 ...
 * @author Kadin
 */
@WebServlet(name = "ProcessApplicationServlet", urlPatterns = {"/ProcessApplicationServlet"})
public class ProcessApplicationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProcessApplicationServlet</title>");            
            out.println("</head>");
            out.println("<body>");
