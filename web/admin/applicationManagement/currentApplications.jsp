            ...
            <div id="main_content_area">
                ...
                <div class="subnav">
                    ...
                    <ul>
                        ...
                        <li class="subnav-item active"><a href="/PostGradSystem/admin/applicationManagement/currentApplications.jsp">Current Applications</a></li>
                        <li class="subnav-item"><a href="/PostGradSystem/admin/applicationManagement/applicationsHistory.jsp">Applications History</a></li>
                        <li class="subnav-item"><a href="/PostGradSystem/admin/applicationManagement/search.jsp">Search</a></li>
                    </ul>
                </div>

                <div class="applicationDateWrapper">
                    <hr>
                    <h3 class="applicationSummaryDate">10 September 2015 <span class="downArrow">&#x25BC;</span></h3>
                    <hr>
                ...
                <div class="applicationDateWrapper">
                    <hr>
                    <h3 class="applicationSummaryDate">9 September 2015 <span class="downArrow">&#x25BC;</span></h3>
                    <hr>
                    <jsp:include page="/WEB-INF/jspf/admin/applicationSummaryTableWithTitle.jspf" flush="true">
                        <jsp:param name="name" value="John Smith" />
                        <jsp:param name="qualification" value="Master of Business Data Science" />
